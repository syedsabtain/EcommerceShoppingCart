    ...
    return (
        <header>
            <nav className="navbar navbar-expand-md navbar-dark fixed-top  bg-transparent ">
                <span className="navbar-brand navbarcolor"><img src={logo2} alt='logo'/>
                    <span className='fornav'>
                        Heart Of Pottery</span>
                </span>
                <button
                ...
                <div className="collapse navbar-collapse ml-5 " id="navbarCollapse">
                    <ul className="navbar-nav mr-auto ml-5">
                        ...
                        <li className="nav-item dropdown ">
                            <a
                                className="nav-link dropdown-toggle fornav"
                                href="#"
                                id="navbarDropdown"
                                role="button"
                        ...
                        <li className="nav-item d-flex float-right">
                            <Link className="nav-link fornav" to='cart'>Cart<span className="badge badge-secondary badge-pill">{Object
                                        .keys(value)
                                        .length}</span>
