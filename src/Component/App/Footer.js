                ...
                <div className="footer  mb-5">
                    ...
                    <div className="container text-center text-md-left mt-5">
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                ...
                                <p>Heart Of Pottery is the main store where you can find every pottery handmade
                                    by one of our finest artist</p>
                            ...
                            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                ...
                                <p>
                                    ...
                                    Heart Of pottery opposite national Measume karachi Pakistan</p>
                                <p>
                                    <i className="fas fa-envelope mr-3"></i>
                                    info@Heartofpottery.com</p>
                                <p>
                    ...
                    <div className="container">
                        ...
                        <div className="sixteen columns text-center">
                            <p className="credits">
                                © 2020
                                <a href="/" title="">Heart Of Pottery</a>.

                                <a href='#'>Created by Syed Sabtain</a>
                            </p>
