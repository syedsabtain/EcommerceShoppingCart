                            ...
                            <tbody>
                                {value
                                    ?.map((val, key) => {
                                        return (
                                            <tr key={key}>
                                                <td><img src={val.image} className='cartimage' alt='cardimage'/>
                                                </td>
                                                <td>{val.name}</td>
                                                <td>In stock</td>
                                                <td >
                                                ...
                                                <td class="text-right">{numberWithCommas(val.price * val.count)}
                                                    $</td>
                                                <td class="text-right">
                                                    <button class="btn btn-sm btn-danger" onClick={() => handledelete(val.id)}>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Sub-Total</td>
                                    <td class="text-right">{numberWithCommas(Subtotal())}
                                        $</td>
                                </tr>
                                <tr>
                                    <td></td>
